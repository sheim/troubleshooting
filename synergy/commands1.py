...
class InternalCommands:
	...
	def configureCore(self, target="", extraArgs=""):
		...
		# Applying https://wordpress.update.sh/archives/410#crayon-548800094b5e1151566511
...
# only on osx 10.9 mavericks and 10.10 yosemite (and foreseeably future releases)
# manually change .xcodeprof to add code sign for
